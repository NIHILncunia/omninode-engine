...
export const adminPermissions = pgTable('admin_permissions', {
  ...
  uniqueIndex('uq_admin_permissions_project_admin_permission').on(table.projectId, table.adminId, table.permissionId),
  index('idx_admin_permissions_project_admin_status').on(table.projectId, table.adminId, table.useYn, table.delYn),
